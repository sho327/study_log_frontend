  ...
  return (
    <Box style={{ 
      ...
      <Stack gap="lg">
        ...
        <Stack gap={4}>
          <Group gap="xs">
            <IconUsers style={{ width: 28, height: 28 }} color="var(--mantine-color-brand-6)" />
        ...
        <Tabs defaultValue="received" variant="pills" color="brand.6" radius="md">
          <Tabs.List mb="md">
            <Tabs.Tab value="received" leftSection={<IconUserPlus size={16} />}>
              届いた招待
              <Badge size="xs" ml={6} variant="filled" color="error">2</Badge>
            </Tabs.Tab>
            <Tabs.Tab value="sent" leftSection={<IconMailForward size={16} />}>
              送信済み
            </Tabs.Tab>
          </Tabs.List>
