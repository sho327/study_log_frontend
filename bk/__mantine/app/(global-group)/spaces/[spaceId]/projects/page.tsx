...
import { 
  IconPlus, IconDotsVertical, IconSettings, IconTrash, 
  IconCalendar, IconChecklist, IconLayoutDashboard, IconArrowRight,
  IconBriefcase
    ...
    <Stack gap="lg">
      ...
      <Group justify="space-between" align="flex-end">
        <Stack gap={4}>
          ...
          <Group gap="xs">
            <IconLayoutDashboard style={{ width: 28, height: 28 }} color="var(--mantine-color-brand-6)" />
    ...
    >
      ...
      <Group justify="space-between" mb="xs">
        ...
        <Menu position="bottom-end" shadow="md" withinPortal>
          ...
          <Menu.Dropdown>
            ...
            <Menu.Item leftSection={<IconSettings size={16} />}>基本情報の編集</Menu.Item>
            <Divider />
            <Menu.Item color="red" leftSection={<IconTrash size={16} />}>プロジェクトを削除</Menu.Item>
          </Menu.Dropdown>
        </Menu>
      </Group>
      ...
      <Group 
        ...
        {project.tags.map((tag: string) => (
          ...
          {/* <Text key={tag} size="xs" c="brand.6" fw={600} bg="brand.1" px={6} py={2} style={{ borderRadius: rem(4) }}> */}
            #{tag}
          </Text>
        ))}
      </Group>
      ...
      <Box mb="md">
        ...
        <Progress 
          ...
          size="md" 
          radius="xl" 
          // striped={project.status === '進行中'}
          // animated={project.status === '進行中'}
        />
      </Box>
      ...
      <Divider 
        mb="md" 
        style={{ 
          // borderColor: 'oklch(0.98 0.001 264)', // text-gray-100
      ...
      <Group justify="space-between" align="center">
        ...
        <Group gap={4} c="dimmed">
          <IconChecklist size={18} color="var(--mantine-color-dimmed)" />
          <Text size="xs" fw={700} me={8} c="dimmed">{project.tasks} タスク</Text>
          {/* <ActionIcon variant="light" color="brand.6" radius="xl">
