...
const INITIAL_NOTIFICATIONS = [
  {
    ...
    time: '2時間前',
    isUnread: true,
    icon: <IconListCheck style={{ width: 18, height: 18 }} />,
    color: 'blue'
  },
  {
    id: '2',
    ...
    time: '5時間前',
    isUnread: true,
    icon: <IconUserPlus style={{ width: 18, height: 18 }} />,
    color: 'green'
  },
  {
    id: '3',
    ...
    time: '昨日',
    isUnread: false,
    icon: <IconInfoCircle style={{ width: 18, height: 18 }} />,
    color: 'gray'
  },
  {
    id: '4',
...
export default function NotificationsPage() {
  ...
  return (
    <Box style={{ width: '100%', margin: '0 auto' }}>
      <Stack gap="xl">
        {/* --- ヘッダーエリア：プロジェクト一覧とデザインを同期 --- */}
        <Group justify="space-between" align="flex-end">
          <Stack gap={4}>
            <Group gap="xs">
              <IconBell style={{ width: 28, height: 28 }} color="var(--mantine-color-brand-6)" />
...
// -----------------------------------------------------------------
// NotificationItem：赤丸ドットによる視認性を最大化したカードコンポーネント
// -----------------------------------------------------------------
  ...
  return (
    ...
    >
      <Card 
        ...
        style={{ 
          // 未読時は背景を純白にして浮き立たせ、枠線をブランドカラーに変更
        ...
        styles={{
          root: {
            '&:hover': {
              backgroundColor: 'oklch(0.96 0.003 264.54) !important', // base-300
      ...
      >
        <Group gap="md" wrap="nowrap" align="center">
          ...
          {/* 【未読強調1】赤丸ドット：ガタつきを防ぐため固定幅のBox内に配置 */}
            ...
            {item.isUnread && (
              <Box 
                style={{ 
                  ...
                  // 白い縁取りとグロー効果で背景色(oklch)からの同化を防ぐ
          ...
          <Menu position="bottom-end" shadow="md" withinPortal transitionProps={{ transition: 'pop-top-right' }}>
            <Menu.Target>
              <ActionIcon 
                ...
                size="lg"
                onClick={(e) => {
                  e.stopPropagation(); // カード本体のクリックイベント（遷移等）を阻止
                }}
              >
            ...
            <Menu.Dropdown>
              ...
              <Menu.Item leftSection={<IconCheck size={14} />}>既読にする</Menu.Item>
              <Divider />
              <Menu.Item color="red" leftSection={<IconTrash size={14} />}>通知を削除</Menu.Item>
            </Menu.Dropdown>
          </Menu>
        </Group>
      </Card>
