...
import { getLog, getUser, toggleLike, addComment, deleteLog, getAllUsers } from '@/lib/store';
import { useRouter, useParams } from 'next/navigation';
import { notifications } from '@mantine/notifications';
import { useEffect, useState, useCallback, useMemo, useRef } from 'react';
import type { StudyLog, User, Comment } from '@/lib/types';
...
export default function LogDetailPage() {
  ...
  const author = useMemo(() => (log ? getUser(log.userId) : null), [log]);
  ...
  const handleComment = async () => {
    ...
    addComment(log.id, user.id, commentText.trim(), replyTo?.userId);
    setCommentText('');
    setReplyTo(null);
